...
PhotonIDisoProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  std::auto_ptr< std::vector< bool > >   photon_looseID ( new std::vector< bool > () );
  std::auto_ptr< std::vector< bool > >   photon_mediumID ( new std::vector< bool > () );
  std::auto_ptr< std::vector< bool > >   photon_tightID ( new std::vector< bool > () );
  //Andres

  std::auto_ptr<std::vector<TLorentzVector> > gammaLVec(new std::vector<TLorentzVector>());
  std::auto_ptr<std::vector<TLorentzVector> > gammaLVecGen(new std::vector<TLorentzVector>());
  ...
  iEvent.put(photon_looseID , "loosePhotonID" );
  iEvent.put(photon_mediumID , "mediumPhotonID" );
  iEvent.put(photon_tightID , "tightPhotonID" );
  ...
  iEvent.put(gammaLVecGen,"gammaLVecGen");
}
