...
#   process.ra2PFCleaningProducts.replace(process.ecalAnomalousFilter, process.dummyCounter1)
   process.ra2PostCleaning.replace(process.ecalDeadCellTPfilter, process.dummyCounter2)
   process.ra2PostCleaning.replace(process.ecalDeadCellBEfilter, process.dummyCounter3)
