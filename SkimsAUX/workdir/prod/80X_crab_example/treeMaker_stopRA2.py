...
process.badGlobalMuonTaggerMAOD.taggingMode = cms.bool(False)
process.cloneGlobalMuonTaggerMAOD.taggingMode = cms.bool(False)
...
process.stopTreeMaker.varsBool.append(cms.InputTag("noBadMuonsFilter"))
