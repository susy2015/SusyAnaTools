...
//    const double zAcc = 0.855;
    ...
    vh.push_back(PHS("norm_cleanmhtphi",             {cleanmhtphi},  {3, 1}, "",                                                             100, -3.14, 3.14, true, true,  "#phi(MH_{T})",   "Norm Events"));

    vh.push_back(PHS("cleanht",                {scaled_cleanht},     {3, 1}, "",                                                             100, 0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("baseline_cleanht",       {scaled_cleanht},     {3, 1}, "passZinvBaseline",                                             50,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_0_cleanht",           {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0",                          100, 0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_1_cleanht",           {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1",                          50,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_2_cleanht",           {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2",                          25,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_3_cleanht",           {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2",                          15,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nt_0_cleanht",           {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;nTopCandSortedCntZinv=0",                100, 0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nt_1_cleanht",           {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;nTopCandSortedCntZinv=1",                50,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nt_2_cleanht",           {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;nTopCandSortedCntZinv=2",                25,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nt_3_cleanht",           {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;nTopCandSortedCntZinv>2",                15,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_0_nt_0_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0;nTopCandSortedCntZinv=0",  50,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_1_nt_0_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1;nTopCandSortedCntZinv=0",  25,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_2_nt_0_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2;nTopCandSortedCntZinv=0",  15,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_3_nt_0_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2;nTopCandSortedCntZinv=0",  10,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_0_nt_1_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0;nTopCandSortedCntZinv=1",  50,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_1_nt_1_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1;nTopCandSortedCntZinv=1",  25,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_2_nt_1_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2;nTopCandSortedCntZinv=1",  15,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_3_nt_1_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2;nTopCandSortedCntZinv=1",  10,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_0_nt_2_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0;nTopCandSortedCntZinv=2",  50,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_1_nt_2_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1;nTopCandSortedCntZinv=2",  25,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_2_nt_2_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2;nTopCandSortedCntZinv=2",  15,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_3_nt_2_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2;nTopCandSortedCntZinv=2",  10,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_0_nt_3_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0;nTopCandSortedCntZinv>2",  50,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_1_nt_3_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1;nTopCandSortedCntZinv>2",  25,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_2_nt_3_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2;nTopCandSortedCntZinv>2",  15,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("nb_3_nt_3_cleanht",      {scaled_cleanht},     {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2;nTopCandSortedCntZinv>2",  10,  0,     2000, true, true,  "H_{T} [GeV]",    "Events"));
    vh.push_back(PHS("cleanmht",               {scaled_cleanmht},    {3, 1}, "",                                                             100, 0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("baseline_cleanmht",      {scaled_cleanmht},    {3, 1}, "passZinvBaseline",                                             50,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_0_cleanmht",          {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0",                          100, 0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_1_cleanmht",          {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1",                          50,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_2_cleanmht",          {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2",                          25,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_3_cleanmht",          {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2",                          15,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nt_0_cleanmht",          {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;nTopCandSortedCntZinv=0",                100, 0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nt_1_cleanmht",          {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;nTopCandSortedCntZinv=1",                50,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nt_2_cleanmht",          {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;nTopCandSortedCntZinv=2",                25,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nt_3_cleanmht",          {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;nTopCandSortedCntZinv>2",                15,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_0_nt_0_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0;nTopCandSortedCntZinv=0",  50,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_1_nt_0_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1;nTopCandSortedCntZinv=0",  25,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_2_nt_0_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2;nTopCandSortedCntZinv=0",  15,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_3_nt_0_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2;nTopCandSortedCntZinv=0",  10,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_0_nt_1_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0;nTopCandSortedCntZinv=1",  50,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_1_nt_1_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1;nTopCandSortedCntZinv=1",  25,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_2_nt_1_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2;nTopCandSortedCntZinv=1",  15,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_3_nt_1_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2;nTopCandSortedCntZinv=1",  10,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_0_nt_2_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0;nTopCandSortedCntZinv=2",  50,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_1_nt_2_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1;nTopCandSortedCntZinv=2",  25,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_2_nt_2_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2;nTopCandSortedCntZinv=2",  15,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_3_nt_2_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2;nTopCandSortedCntZinv=2",  10,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_0_nt_3_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0;nTopCandSortedCntZinv>2",  50,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_1_nt_3_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1;nTopCandSortedCntZinv>2",  25,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_2_nt_3_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2;nTopCandSortedCntZinv>2",  15,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("nb_3_nt_3_cleanmht",     {scaled_cleanmht},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2;nTopCandSortedCntZinv>2",  10,  0,     1500, true, true,  "MH_{T} [GeV]",   "Events"));
    vh.push_back(PHS("cleanmet",               {scaled_cleanMet},    {3, 1}, "",                                                             100, 0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("baseline_cleanmet",      {scaled_cleanMet},    {3, 1}, "passZinvBaseline",                                             50,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_0_cleanmet",          {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0",                          100, 0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_1_cleanmet",          {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1",                          50,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_2_cleanmet",          {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2",                          25,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_3_cleanmet",          {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2",                          15,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nt_0_cleanmet",          {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;nTopCandSortedCntZinv=0",                100, 0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nt_1_cleanmet",          {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;nTopCandSortedCntZinv=1",                50,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nt_2_cleanmet",          {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;nTopCandSortedCntZinv=2",                25,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nt_3_cleanmet",          {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;nTopCandSortedCntZinv>2",                15,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_0_nt_0_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0;nTopCandSortedCntZinv=0",  50,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_1_nt_0_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1;nTopCandSortedCntZinv=0",  25,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_2_nt_0_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2;nTopCandSortedCntZinv=0",  15,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_3_nt_0_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2;nTopCandSortedCntZinv=0",  10,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_0_nt_1_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0;nTopCandSortedCntZinv=1",  50,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_1_nt_1_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1;nTopCandSortedCntZinv=1",  25,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_2_nt_1_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2;nTopCandSortedCntZinv=1",  15,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_3_nt_1_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2;nTopCandSortedCntZinv=1",  10,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_0_nt_2_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0;nTopCandSortedCntZinv=2",  50,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_1_nt_2_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1;nTopCandSortedCntZinv=2",  25,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_2_nt_2_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2;nTopCandSortedCntZinv=2",  15,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_3_nt_2_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2;nTopCandSortedCntZinv=2",  10,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_0_nt_3_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=0;nTopCandSortedCntZinv>2",  50,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_1_nt_3_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=1;nTopCandSortedCntZinv>2",  25,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_2_nt_3_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv=2;nTopCandSortedCntZinv>2",  15,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nb_3_nt_3_cleanmet",     {scaled_cleanMet},    {3, 1}, "passZinvBaselineNoTag;cntCSVSZinv>2;nTopCandSortedCntZinv>2",  10,  0,     1500, true, true,  "MET [GeV]",      "Events"));
    vh.push_back(PHS("nTop",                   {scaled_nTop},        {3, 1}, "",                                                             10,  0,       10, true, true,  "N(t)",           "Events"));
    vh.push_back(PHS("baseline_nTop",          {scaled_nTop},        {3, 1}, "passZinvBaseline",                                             10,  0,       10, true, true,  "N(t)",           "Events"));
    vh.push_back(PHS("cleannJet",              {scaled_nCleanJet},   {3, 1}, "",                                                             20,  0,       20, true, true,  "N(jet)",         "Events"));
    vh.push_back(PHS("baseline_cleannJet",     {scaled_nCleanJet},   {3, 1}, "passZinvBaseline",                                             20,  0,       20, true, true,  "N(jet)",         "Events"));
    vh.push_back(PHS("nBottom",                {scaled_nBottom},     {3, 1}, "",                                                             10,  0,       10, true, true,  "N(b)",           "Events"));
    vh.push_back(PHS("baseline_nBottom",       {scaled_nBottom},     {3, 1}, "passZinvBaseline",                                             10,  0,       10, true, true,  "N(b)",           "Events"));
    vh.push_back(PHS("cleanmhtphi",            {scaled_cleanmhtphi}, {3, 1}, "",                                                             100, -3.14, 3.14, true, true,  "#phi(MH_{T})",   "Events"));
