...
int main()
{
    ...
    Plotter::DataCollection dcDY_MuEffPt(  "ratio",  {{"genMatchMu(pt)", dsDY_ll},  {"genMu(pt)", dsDY_ll}});
    Plotter::DataCollection dcDY_MuEffEta( "ratio",  {{"genMatchMu(eta)", dsDY_ll}, {"genMu(eta)", dsDY_ll}});
    ...
    vh.push_back(PHS("met",           {met},          {1, 2}, "", 100, 0, 1000,  true,  true,  "MET [GeV]",          "Norm Events"));
    vh.push_back(PHS("ht",            {ht},           {1, 2}, "", 100, 0, 1500,  true,  true,  "H_{T} [GeV]",        "Norm Events"));
    vh.push_back(PHS("nMuons",        {nMuon},        {1, 2}, "", 10,  0, 10,   true,  false, "N(#mu)",             "Events"));
    vh.push_back(PHS("jetPt",         {jetPt},        {1, 2}, "", 100, 0, 1000,  true,  true,  "Jet p_{T} [GeV]",    "Norm Events"));
    vh.push_back(PHS("cleanJetPt",    {cleanJetPt},   {1, 2}, "", 100, 0, 1000,  true,  true,  "Cleaned Jet p_{T} [GeV]", "Norm Events"));
    ...
    vh.push_back(PHS("genZPt",        {genZPt},       {1, 2}, "", 100, 0, 1000,  true,  true,  "gen Z p_{T} [GeV]",  "Norm Events"));
    vh.push_back(PHS("genZEta",       {genZEta},      {1, 2}, "", 100, -3, 3,   false, true,  "gen Z #eta",         "Norm Events"));
    vh.push_back(PHS("genZmass",      {genZmass},     {1, 2}, "", 100, 0, 800,  true,  true,  "gen M(Z) [GeV]",     "Norm Events"));
    vh.push_back(PHS("bestRecoZPt"  , {bestZPt},      {1, 2}, "", 100, 0, 1000,  true,  true,  "Z p_{T} [GeV]",      "Norm Events"));    
    vh.push_back(PHS("bestRecoZMass", {bestZM},       {1, 2}, "", 100, 0, 800,  true,  true,  "M(Z) [GeV]",         "Norm Events"));    

    vh.push_back(PHS("cleanht",          {cleanht},     {2, 3}, "",             100, 0,     1500,  true, true,  "H_{T} [GeV]",         "Norm Events"));
    vh.push_back(PHS("cleanht_baseline", {cleanht},     {2, 3}, "passBaseline", 100, 0,     1500,  true, true,  "H_{T} [GeV]",         "Norm Events"));
    vh.push_back(PHS("cleanmht",         {cleanmht},    {2, 3}, "",             100, 0,     1000,   true, true,  "MH_{T} [GeV]",        "Norm Events"));
    vh.push_back(PHS("cleanmhtphi",      {cleanmhtphi}, {2, 3}, "",             100, -3.14, 3.14, true, true,  "#phi(MH_{T})",        "Norm Events"));
    vh.push_back(PHS("cleanmet",         {cleanMet},    {2, 3}, "",             100, 0,     1000,  true, true,  "MET [GeV]",           "Norm Events"));

    vh.push_back(PHS("effMuPt",       {dcDY_MuEffPt},   {1, 1}, "",             100, 0,     600, true, false,  "#mu p_{T} [GeV]",  "Efficiency"));
