...
int Plot_1D_test()
{
	...
	TString signal_name = "T2tt_and_T1tttt";
	...
	if(sig_scale_to_BG) signal_scale = hs_tot; 
	...
	if (true)
	{
		...
		if(signal_name == "T2tt_and_T1tttt") sp = "T2tt_mStop1000_mLSP1";
	...
	if (true)
	{
		...
		if(signal_name == "T2tt_and_T1tttt") sp = "T1tttt_mGluino2000_mLSP100";
