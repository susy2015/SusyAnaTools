...
folder_name = "SMS_T2tt_mStop_150to250_fastsim_2017"
folder_path = "/eos/uscms/store/user/lpcsusyhad/Stop_production/Fall17_94X_v2_NanAOD_MC/PostProcessed_18Apr2019_v2p7p1_fastsimv3/"
...
for item in mass_point_list:
	...
	out_name = "SMS_T2tt_mStop" + mother_mass + "_mLSP" + LSP_mass + "_fastsim"
	out_file_list.append(out_name)
	out_name = out_name + "_2017"
