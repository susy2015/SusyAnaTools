...
#foreach mp ("`cat T2fbd_mass_points.txt`")
	...
	#../make_signalcards $mother $daughter SMS_T2tt_mStop${mother}_mLSP${daughter}_fastsim_2016_0 search_bin_v2_h 53 
	../make_signalcards $mother $daughter SMS_T1tttt_mGluino${mother}_mLSP${daughter}_fastsim_2016_0 search_bin_v2_h 53
