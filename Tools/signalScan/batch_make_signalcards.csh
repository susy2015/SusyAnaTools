...
#foreach mp ("`cat T1tttt_mass_points.txt`")
	...
	./make_signalcards $mother $daughter Signal_fastsim_T2tt_mStop${mother}_mLSP${daughter} search_bin_v2_h 
	...
	#./make_signalcards $mother $daughter Signal_fastsim_T1tttt_mGluino${mother}_mLSP${daughter} search_bin_v2_h 
