...
foreach mp ("`cat T2fbd_mass_points.txt`")
	...
	../make_signalcards $mother $daughter SMS_T2fbd_mStop${mother}_mLSP${daughter}_fastsim search_bin_v4_h search_bin_v4_singleMuCR_h search_bin_v4_singleElCR_h 53 
end
