...
namespace AnaSamples
{
    ...
    SampleSet::SampleSet(std::string fDir) : fDir_(fDir)
    {
        ...
        sampleSet_["TTbar_HT-600to800"]  = FileSummary(fDir_ + "TTJets_HT-600to800_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.txt",     "stopTreeMaker/AUX", 2.61537118,  lumi, 4964914, 1.0, kGreen);
        sampleSet_["TTbar_HT-800to1200"]  = FileSummary(fDir_ + "TTJets_HT-800to1200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.txt",   "stopTreeMaker/AUX", 1.07722318,  lumi, 3445059, 1.0, kGreen);
        sampleSet_["TTbar_HT-1200to2500"]  = FileSummary(fDir_ + "TTJets_HT-1200to2500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.txt", "stopTreeMaker/AUX", 0.194972521,  lumi, 987054, 1.0, kGreen);
        sampleSet_["TTbar_HT-2500toInf"]  = FileSummary(fDir_ + "TTJets_HT-2500toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.txt",   "stopTreeMaker/AUX", 0.0023234211,  lumi, 507842, 1.0, kGreen);

        sampleSet_["TTbarDiLep"]  = FileSummary(fDir_ + "TTJets_DiLept_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.txt", "stopTreeMaker/AUX", 86.66,  lumi, 30245565, 1.0, kGreen);

        sampleSet_["TTbarSingleLepT"]  = FileSummary(fDir_ + "TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.txt", "stopTreeMaker/AUX", 179.25,  lumi, 58191088, 1.0, kGreen);

        sampleSet_["TTbarSingleLepTbar"]  = FileSummary(fDir_ + "TTJets_SingleLeptFromTbar_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.txt", "stopTreeMaker/AUX", 179.25,  lumi, 108449185, 1.0, kGreen);
	...
	// To be updated
        ...
        sampleSet_["QCD_Pt_10to15"]       = FileSummary(fDir_ + "QCD_Pt_10to15_TuneCUETP8M1_13TeV_pythia8.txt",     "stopTreeMaker/AUX", , lumi, 3449170, 1.0,  kBlue);
