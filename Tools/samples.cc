...
// Additional signals
	...
	addSampleSet(samples, "WJetsToLNuInc", {"WJetsToLNu_Inc"});
        ...
        addSampleSet(samples, "ZJetsToNuNu", {"ZJetsToNuNu_HT_400to600"});
...
//      addSampleSet(samples, "Data_HTMHT", {"Data_HTMHT_2015C", "Data_HTMHT_2015D_05Oct2015", "Data_HTMHT_2015D_PromptReco"});
        ...
        addSampleSet(samples, "Signal_fastsim_T2tt_scan", {"SMS-T2tt_mStop-250to350", "SMS-T2tt_mStop-350to400", "SMS-T2tt_mStop-400to1200"});
