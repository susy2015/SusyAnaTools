...
namespace AnaSamples
{
    ...
    SampleSet::SampleSet(std::string fDir, double lumi) : fDir_(fDir), lumi_(lumi)
    {
        ...
        addSample("TTbar_HT-600to800_deepTrimmed", fDir_ + deepTrimmed_loc + "TTJets_HT-600to800.txt",   "stopTreeMaker/AUX", 2.666535,    lumi, 14210872, 1.0, kGreen);
        // 0.663 * kt
        addSample("TTbar_HT-800to1200_deepTrimmed", fDir_ + deepTrimmed_loc + "TTJets_HT-800to1200.txt",  "stopTreeMaker/AUX", 1.098082,    lumi, 9982765, 1.0, kGreen);
        // 0.12 * kt
        addSample("TTbar_HT-1200to2500_deepTrimmed", fDir_ + deepTrimmed_loc + "TTJets_HT-1200to2500.txt", "stopTreeMaker/AUX", 0.198748,    lumi, 2932983, 1.0, kGreen);
        // 0.00143 * kt
        addSample("TTbar_HT-2500toInf_deepTrimmed", fDir_ + deepTrimmed_loc + "TTJets_HT-2500toInf.txt",  "stopTreeMaker/AUX", 0.002368413, lumi, 1519815,  1.0, kGreen);
        ...
        // deep trimmed ...
        addSample("TTbarDiLep_deepTrimmed",         fDir_ + deepTrimmed_loc + "TTJets_DiLept.txt",             "stopTreeMaker/AUX", 831.76*TTbar_DiLept_BR,         lumi, 30444678, 1.0, kGreen);
        addSample("TTbarSingleLepT_deepTrimmed",    fDir_ + deepTrimmed_loc + "TTJets_SingleLeptFromT.txt", "stopTreeMaker/AUX", 831.76*0.5*TTbar_SingleLept_BR, lumi, 61901450, 1.0, kGreen);
        addSample("TTbarSingleLepTbar_deepTrimmed", fDir_ + deepTrimmed_loc + "TTJets_SingleLeptFromTbar.txt",    "stopTreeMaker/AUX", 831.76*0.5*TTbar_SingleLept_BR, lumi, 59860282, 1.0, kGreen);
...
//        addSample("WJetsToLNu_Inc_deepTrimmed", fDir_ + MCloc + "WJetsToLNu.txt", "stopTreeMaker/AUX", 61526.7,  lumi, 28161602,  1.21, kMagenta+1);
        ...
        addSample("WJetsToLNu_HT_70to100_deepTrimmed",    fDir_ + deepTrimmed_loc + "WJetsToLNu_HT-70To100.txt", "stopTreeMaker/AUX", 1319,  lumi, 10034066,  1.21, kMagenta+1);
        addSample("WJetsToLNu_HT_100to200_deepTrimmed",   fDir_ + deepTrimmed_loc + "WJetsToLNu_HT-100To200.txt", "stopTreeMaker/AUX", 1345,  lumi, 79065975,  1.21, kMagenta+1);
        addSample("WJetsToLNu_HT_200to400_deepTrimmed",   fDir_ + deepTrimmed_loc + "WJetsToLNu_HT-200To400.txt", "stopTreeMaker/AUX", 359.7,  lumi, 38867206,  1.21, kMagenta+1);
        addSample("WJetsToLNu_HT_400to600_deepTrimmed",   fDir_ + deepTrimmed_loc + "WJetsToLNu_HT-400To600.txt", "stopTreeMaker/AUX", 48.91,  lumi, 7759701,  1.21, kMagenta+1);
        addSample("WJetsToLNu_HT_600to800_deepTrimmed",   fDir_ + deepTrimmed_loc + "WJetsToLNu_HT-600To800.txt", "stopTreeMaker/AUX", 12.05,  lumi, 17494743,  1.21, kMagenta+1);
        addSample("WJetsToLNu_HT_800to1200_deepTrimmed",  fDir_ + deepTrimmed_loc + "WJetsToLNu_HT-800To1200.txt", "stopTreeMaker/AUX",  5.501,   lumi, 7745467,  1.21, kMagenta+1);
        addSample("WJetsToLNu_HT_1200to2500_deepTrimmed", fDir_ + deepTrimmed_loc + "WJetsToLNu_HT-1200To2500.txt", "stopTreeMaker/AUX", 1.329,   lumi, 6801534,   1.21, kMagenta+1);
        addSample("WJetsToLNu_HT_2500toInf_deepTrimmed",  fDir_ + deepTrimmed_loc + "WJetsToLNu_HT-2500ToInf.txt", "stopTreeMaker/AUX",  0.03216, lumi, 2637821,   1.21, kMagenta+1);
        ...
        // deep trimmed ...
        addSample("tW_top_incl_deepTrimmed", fDir_ + deepTrimmed_loc + "ST_tW_top_5f_inclusiveDecays.txt", "stopTreeMaker/AUX", 35.6, lumi,  6774350,  1.0,  kYellow);
        addSample("tW_antitop_incl_deepTrimmed", fDir_ + deepTrimmed_loc + "ST_tW_antitop_5f_inclusiveDecays.txt", "stopTreeMaker/AUX", 35.6, lumi, 6933094,  1.0,  kYellow);
        addSample("tW_top_NoHad_deepTrimmed", fDir_ + deepTrimmed_loc + "ST_tW_top_5f_NoFullyHadronicDecays.txt", "stopTreeMaker/AUX", 35.6*(1-W_Had_BR*W_Had_BR), lumi,  11345619,  1.0,  kYellow);
        addSample("tW_antitop_NoHad_deepTrimmed", fDir_ + deepTrimmed_loc + "ST_tW_antitop_5f_NoFullyHadronicDecays.txt", "stopTreeMaker/AUX", 35.6*(1-W_Had_BR*W_Had_BR), lumi, 11408144,  1.0,  kYellow);
        ...
        addSample("Data_MET_deepTrimmed", fDir_ + deepTrimmed_loc + "MET.txt", "stopTreeMaker/AUX", 36813.714859265, 1.0,  kBlack);
