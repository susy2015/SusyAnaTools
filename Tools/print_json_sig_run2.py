...
def myprocess(sample,mass_point,bintype):
    ...
    #infilename = "fastsimstuff/v6p5/{0}.root".format(mass_point)
    infilename = "fastsimstuff/v6p5/{0}_2016.root".format(mass_point)
...
if __name__ == "__main__":
    ...
    fastsimdir = os.path.abspath("fastsimstuff/v6p5/{0}_2016".format(samplename))
    ...
    with open(args.config, "r") as infile:
        for line in infile:
            ...
            for ext in testext:
                ...
                if ext in testext: hist_up.GetYaxis().SetRangeUser(0.4,1.6)
                hist_up.Draw()
                ...
                mycanvas.SaveAs("fastsimstuff/v6p5/{0}_2016/{1}{2}.png".format(samplename,shortmasspoint,ext))
            ...
            for ext in testext:
                ...
                leg.Draw("same")
                #mycanvas.SaveAs("VBSB_plots/v5signal_nofastSF/{0}{1}.png".format(shortmasspoint,ext))
                mycanvas.SaveAs("fastsimstuff/v6p5/{0}{1}_lepCR.png".format(shortmasspoint,ext))
                #c = raw_input("Press Enter to continue")
            '''
            '''
            mycanvas = ROOT.TCanvas(shortmasspoint, shortmasspoint, 600, 600)
            ...
            for ext in testext:
                ...
                mycanvas.SaveAs("fastsimstuff/v6p5/{0}{1}_vb_highdm.png".format(shortmasspoint,ext))
                '''
    j = {}
    ...
    for point in mass_point_list:
        ...
        json_outfile = "fastsimstuff/v6p5/{0}_2016/{1}.json".format(samplename,point)
        ...
        syst_outfile = "fastsimstuff/v6p5/{0}_2016/{1}_syst.conf".format(samplename,point)
        print "Creating file {0}".format(syst_outfile)
