...
void BaselineVessel::PassHEMVeto()
{
    ...
    SAT_Pass_HEMVeto = SAT_Pass_HEMVeto && PassObjectVeto(Electrons, wide_eta_low,  wide_eta_high,  wide_phi_low,   wide_phi_high, min_electron_pt);
    ...
    SAT_Pass_HEMVeto = SAT_Pass_HEMVeto && PassObjectVeto(Photons,   wide_eta_low,  wide_eta_high,  wide_phi_low,   wide_phi_high, min_photon_pt);
