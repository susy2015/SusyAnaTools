...
void SearchBins::drawSBregionDef(const double ymin_Yields, const double ymax_Yields, const bool logscale){
	...
	if(NSB == 84)
	  {
	    ...
	    ttext_ntop->DrawLatex(20.5 + adjHalfBin, ymax_Yields/2 ,"N_{t} = 1");
            ttext_ntop->DrawLatex(57.5 + adjHalfBin, ymax_Yields/1000. ,"N_{t} = 2");
            ttext_ntop->SetTextAngle(90.);
            ttext_ntop->DrawLatex(79.5 + adjHalfBin, ymax_Yields/200. ,"N_{t} #geq 3");
    ...
    ttext2->SetTextSize(0.030);
    ttext2->SetTextAlign(22);
    ttext2->Draw();

    if(logscale)
      {
        ttext2->DrawLatex( 4.5 + adjHalfBin, ymax_Yields/10., "N_{b} = 1");
	if(NSB == 84)
	  {
	    
	    ttext2->DrawLatex(27.5 + adjHalfBin, ymax_Yields/200, "N_{b} = 2");
            ttext2->SetTextAngle(90.);
            ttext2->DrawLatex(37.5  + adjHalfBin, ymax_Yields/10 , "N_{b} #geq 3");
          }
	...
	if(NSB == 84)
	    ...
	    ttextmt2->DrawLatex( 3.0, ymax_Yields/1000. , "M_{T2}=[250,300]");
            ttextmt2->DrawLatex( 12.5, ymax_Yields/1000. , "M_{T2}=[400, 550]");
	    ttextmt2->DrawLatex( 19.5, ymax_Yields/1000. , "M_{T2}#geq800 GeV");
	    ttextmt2->DrawLatex( 39.5, ymax_Yields/5000. , "H_{T}=[300,1000]");
	    ttextmt2->DrawLatex( 46.5, ymax_Yields/1000. , "H_{T}#geq1500 GeV");
            ttextmt2->DrawLatex( 76.5, ymax_Yields/10000. , "H_{T}#geq1300 GeV");
	    ttextmt2->DrawLatex( 80.5, ymax_Yields/20000. , "H_{T}#geq300 GeV");
