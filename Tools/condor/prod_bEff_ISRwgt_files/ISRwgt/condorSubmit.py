...
Transfer_Input_Files = $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/ISRJetsProducer, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/condor/prod_bEff_ISRwgt_files/ISRwgt/goMakePlots.sh, $ENV(CMSSW_BASE)/lib/$ENV(SCRAM_ARCH)/librecipeAUXOxbridgeMT2.so, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/TopTagger.cfg, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/TrainingOutput_dR20_pt30_depth14_2016_Dec2.model, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/Legacy_TopTagger.cfg, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/puppiSoftdropResol.root, TRANS_TAR_BALL_CMSSW
