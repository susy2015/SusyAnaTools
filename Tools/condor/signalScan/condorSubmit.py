...
Transfer_Input_Files = $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/signalScan, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/condor/signalScan/goScan.sh, $ENV(CMSSW_BASE)/lib/$ENV(SCRAM_ARCH)/librecipeAUXOxbridgeMT2.so, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/data/signalScan_fastsim_T2tt_bTagEff_ISR.root, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/data/signalScan_fastsim_T1tttt_bTagEff_ISR.root, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/data/signalScan_fastsim_T5ttcc_bTagEff_ISR.root, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/data/signalScan_fastsim_T5tttt_dM175_bTagEff_ISR.root, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/data/signalScan_fastsim_T1ttbb_bTagEff_ISR.root, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/CSVFiles/CSVv2_Moriond17_B_H.csv, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/CSVFiles/fastsim_csvv2_ttbar_26_1_2017.csv, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/ISR_Root_Files/ISRWeights.root, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/LeptonSF_Root_Files/allINone_leptonSF_Moriond17.root, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/TopTagger.cfg, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/TrainingOutput_dR20_pt30_depth12_500tree_2017_Feb16.model, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/data/puppiCorr.root, TRANS_TAR_BALL_CMSSW
