...
git clone -b Ana_Dec30_2016_Moriond2017_updatesForSBStudies git@github.com:susy2015/SusyAnaTools.git
scram b -j9
```
...
```
$CMSSW_BASE/src/TopTagger/Tools/getTaggerCfg.sh -t Legacy_AK4Only_v0.0.0 -f Legacy_TopTagger.cfg -d PATH_TO_DOWNLOAD_TO
```
